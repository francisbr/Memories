...
<div class="container">
	...
	<div class="panel panel-primary">
		<div class="panel-heading">Francis Boulet-Rouleau</div>
		<div class="panel-footer">
			<div class="row">
				...
				<div class="col-sm-4" style="margin: 0px;">
					<video class="panel-body video" style="width: 100%; margin: -0px; padding: 0px; " id="bgVideo" loop  muted="" onmouseover="this.play();" onmouseout="this.pause();">
						<source src="video1.mp4" type="video/mp4"></source>
					</video>
				</div>
			</div>
